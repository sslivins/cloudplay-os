...
class Service:
    ...
    def status(self):
        ...
        if self._worker_lock.locked():
            ...
            if self._command == "check" and status["phase"] in (
                    "idle", "available", "promoted", "failed", "rolled_back", "checking"):
                status.update(phase="checking", available_version=None, candidate_version=None,
